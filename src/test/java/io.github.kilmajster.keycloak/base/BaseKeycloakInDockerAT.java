...
public abstract class BaseKeycloakInDockerAT {
    ...
    protected String getKeycloakBaseUrl(final int dockerFirstMappedPort) {
        return isHeadless() ? KEYCLOAK_DOCKER_URL : KEYCLOAK_LOCAL_URL_PREFIX + dockerFirstMappedPort;
    }
}